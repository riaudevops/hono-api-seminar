...
} from '../validators/komponen-penilaian.validator';

const komponenRoute = new Hono({ router: new RegExpRouter() });

komponenRoute.get('/komponen-penilaian', KomponenPenilaianHandler.getAll);
komponenRoute.post(
  '/komponen-penilaian',
...
komponenRoute.delete('/komponen-penilaian/:id', KomponenPenilaianHandler.delete);
