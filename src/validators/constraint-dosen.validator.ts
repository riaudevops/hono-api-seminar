...
export const postConstraintSchema = z
  .object({
    ...
    priority: z.number().int("Prioritas harus berupa bilangan bulat").min(1, "Prioritas minimal 1").max(5, "Prioritas maksimal 5").default(1),
...
export const putConstraintSchema = z
  .object({
    ...
    waktu_selesai: z
      ...
      .nullable()
      .optional(),
    keterangan: z.string().max(500, "Keterangan maksimal 500 karakter").nullable().optional(),
    priority: z.number().int("Prioritas harus berupa bilangan bulat").min(1, "Prioritas minimal 1").max(5, "Prioritas maksimal 5").optional(),
